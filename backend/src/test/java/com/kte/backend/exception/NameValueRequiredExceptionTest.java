...
@DisplayName("NameValueRequiredException Tests")
class NameValueRequiredExceptionTest {

    @Test
    @DisplayName("Should create exception with message only")
    void should_Create_With_Message() {
        final NameValueRequiredException exception = new NameValueRequiredException("Name is required");
    ...
    void should_Create_With_Message_And_Cause() {
        ...
        final NameValueRequiredException exception = new NameValueRequiredException("Name is required", cause);
    ...
    void should_Create_With_Cause_Only() {
        ...
        final NameValueRequiredException exception = new NameValueRequiredException(cause);
    ...
    void should_Create_With_All_Args() {
        ...
        final NameValueRequiredException exception =
                new NameValueRequiredException("Name is required", cause, false, false);
